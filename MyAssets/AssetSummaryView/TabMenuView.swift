...
struct TabMenuView: View {
    ...
    @Binding var updated: CreditCardAmounts? // 업데이트 내용이 있다면 빨간 점으로 표현
    var body: some View {
        HStack {
...
struct TabMenuView_Previews: PreviewProvider {
    static var previews: some View {
        TabMenuView(tabs: ["지난달 결제", "이번달 결제", "다음달 결제"], selectedTab: .constant(1), updated: .constant(.previousMonth(amount: "10,000원")))
    }
}
